  ...
  export default ({history}) => (
    ...
    <View style={styles.header_logo}>
      ...
      <View style={styles.buttons}>
        <TouchableOpacity onPress={() => history.push("/AdicionarRank1v1")}>
       <AddRank text = "Ranks 1v1" />
       </TouchableOpacity>

       <TouchableOpacity onPress={() => history.push("/AdicionarRank2v2")}>
       <AddRank text = "Ranks 2v2"/>
       </TouchableOpacity>

       <TouchableOpacity onPress={() => history.push("/AdicionarRank3v3")}>
       <SeeRank text = "Ranks 3v3" />
       </TouchableOpacity>
      </View>

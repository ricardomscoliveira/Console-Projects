  ...
  export default ({history}) => (
    ...
    <View style={styles.header_logo}>
      ...
      <View style={styles.buttons}>
       <TouchableOpacity onPress={() => history.push("/ConsultarRank1v1")}>
       <AddRank text = "Ranks 1v1" />
       </TouchableOpacity>

       <TouchableOpacity onPress={() => history.push("/ConsultarRank2v2")}>
       <AddRank text = "Ranks 2v2"/>
       </TouchableOpacity>

       <TouchableOpacity onPress={() => history.push("/ConsultarRank3v3")}>
